...
namespace HospitalWebApi.Migrations
{
    ...
    [Migration("20180515132813_SensorChanges")]
    partial class SensorChanges
    {
            ...
            modelBuilder.Entity("HospitalWebApi.Models.Patient", b =>
                {
                    b.HasOne("HospitalWebApi.Models.Sensor", "Sensor")
                        .WithOne("Patient")
                        .HasForeignKey("HospitalWebApi.Models.Patient", "SensorId");
            ...
            modelBuilder.Entity("HospitalWebApi.Models.Temperature", b =>
                {
                    ...
                    b.HasOne("HospitalWebApi.Models.Sensor")
