...
namespace HospitalWebApi.Migrations
{
    ...
    [Migration("20180418134929_Session Variable for Users")]
    partial class SessionVariableforUsers
    {
            ...
            modelBuilder.Entity("HospitalWebApi.Models.Patient", b =>
                {
                    ...
                    b.HasIndex("TemperatureId")
                        .IsUnique()
                        .HasFilter("[TemperatureId] IS NOT NULL");
            ...
            modelBuilder.Entity("HospitalWebApi.Models.Patient", b =>
                {
                    b.HasOne("HospitalWebApi.Models.Temperature", "Temperature")
                        .WithOne("Patient")
                        .HasForeignKey("HospitalWebApi.Models.Patient", "TemperatureId");
